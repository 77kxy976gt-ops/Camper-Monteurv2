    ...
    <div className="bg-brand-gray p-6 rounded-xl shadow-lg h-full flex flex-col border border-gray-200">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col flex-grow">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          <div>
            ...
            <input
              ...
              className="w-full p-3 bg-gray-50 border border-brand-lightgray rounded-lg focus:ring-2 focus:ring-brand-lightblue focus:outline-none transition-all duration-200 text-gray-800"
              disabled={isLoading}
            />
          </div>
          <div>
        ...
        <textarea
          ...
          className="flex-grow w-full p-3 bg-gray-50 border border-brand-lightgray rounded-lg focus:ring-2 focus:ring-brand-lightblue focus:outline-none transition-all duration-200 text-gray-800 resize-none min-h-[150px] lg:min-h-0"
          disabled={isLoading}
        />
        <button
          type="submit"
